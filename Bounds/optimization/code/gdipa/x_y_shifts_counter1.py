...
deltas = [1, 1, 1, 1, 1, 1] # one for each transition
...
for deltas in itertools.product([-1, 1], repeat=6):
    ...
    constraints.append(And(variables[2][0] <= variables[0][0], variables[2][1] >= variables[1][0]))
    ...
    constraints.append(And(variables[4][0] >= variables[0][0], variables[4][1] <= variables[1][0]))
