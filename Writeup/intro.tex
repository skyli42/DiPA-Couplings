...
\begin{itemize}
    ...
    \item We show an equivalence between our program model exactly coincides with a previously developed automata-theoretic model known as DiPA \cite{chadhaLinearTimeDecidability2021} and discuss connections between the two proof approaches. 
