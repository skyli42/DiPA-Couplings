...
\sky{include a definition of leaking pair in the single variable section as an example so that this makes sense}
\sky{also triple check this definition since it's a bit finicky}
\begin{defn}
...
Incorporating this exception, we still have that an unsatisfiable coupling strategy implies the presence of these ``bad'' graph structures. 
