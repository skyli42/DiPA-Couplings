...
\title{Efficient Decision Procedures for Differential Privacy via Probabilistic Couplings}
\date{April 2024}
\author{Sky Li\\ Computer Science, University of Toronto
\and Supervised by Azadeh Farzan and Aleksandar Nikolov}
...
We model programs as regular languages comprised of possible program executions, each corresponding to a word in the language. This approach simultaneously allows us to build approximate liftings for each straight line program that prove the overall privacy of a program.

We begin with individual program transitions, which correspond directly to characters in our alphabet.
...
\section{Optimizing Privacy Cost with Couplings}\label{svOptimizationSection}
...
\input{appendix-2varcounterexamples.tex}
